  ...
  return {
    ...
    upgrades: {
      regen: {
        ...
        costBase: 25,
        costMult: 1.8,
        name: 'games.cyber_snare.upgrades.items.regen.name',
        desc: 'games.cyber_snare.upgrades.items.regen.description',
      },
      energy: {
        lvl: 0,
        max: 10,
        costBase: 25,
        costMult: 1.8,
        name: 'games.cyber_snare.upgrades.items.energy.name',
        desc: 'games.cyber_snare.upgrades.items.energy.description',
      },
      loot: {
        lvl: 0,
        max: 5,
        costBase: 50,
        costMult: 2.5,
        name: 'games.cyber_snare.upgrades.items.loot.name',
        desc: 'games.cyber_snare.upgrades.items.loot.description',
      },
      lives: {
        lvl: 0,
        max: 5,
        costBase: 200,
        costMult: 3.0,
        name: 'games.cyber_snare.upgrades.items.lives.name',
        desc: 'games.cyber_snare.upgrades.items.lives.description',
      },
      fw_persist: {
        lvl: 0,
        max: 5,
        costBase: 150,
        costMult: 2.2,
        name: 'games.cyber_snare.upgrades.items.fw_persist.name',
        desc: 'games.cyber_snare.upgrades.items.fw_persist.description',
      },
      emp_cascade: {
        lvl: 0,
        max: 3,
        costBase: 400,
        costMult: 3.5,
        name: 'games.cyber_snare.upgrades.items.emp_cascade.name',
        desc: 'games.cyber_snare.upgrades.items.emp_cascade.description',
      },
      heal: {
        lvl: 0,
        max: 99,
        costBase: 50,
        costMult: 1.0,
        name: 'games.cyber_snare.upgrades.items.heal.name',
        desc: 'games.cyber_snare.upgrades.items.heal.description',
      },
    },
  };
}
