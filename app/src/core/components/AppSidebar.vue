...
<template>
  ...
  <aside
    class="sidebar transition-all duration-200 ease-[cubic-bezier(0.4, 0, 0.2, 1)] flex flex-col justify-between shrink-0 overflow-hidden h-dvh p-3 bg-surface border-r border-surface-border z-10001"
    :class="[
      'md:sticky md:top-0',
