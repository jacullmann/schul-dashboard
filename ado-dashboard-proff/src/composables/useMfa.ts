...
export function useMfa() {
    ...
    // mfa aktivieren
    async function activateMfa(code: string): Promise<{ ok: boolean; error?: string }> {
        mfaLoading.value = true;
        mfaError.value = null;
    ...
    // mfa deaktivieren
    async function deactivateMfa(code: string): Promise<{ ok: boolean; error?: string }> {
        mfaLoading.value = true;
        mfaError.value = null;
    ...
    async function verifyMfaLogin(code: string): Promise<{ ok: boolean; csrfToken?: string; error?: string }> {
        mfaLoading.value = true;
        mfaError.value = null;
