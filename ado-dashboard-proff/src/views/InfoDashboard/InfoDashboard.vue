...
import { useArticleSearch } from '@/views/InfoDashboard/useArticleSearch';
import ArticleCard from '@/views/InfoDashboard/ArticleCard.vue';
...
const topicOptions = computed(() => [
  { value: 'All', label: t('info.dashboard.categories.all') },
  { value: 'Technologie', label: t('info.dashboard.categories.technology') },
  { value: 'Politik', label: t('info.dashboard.categories.politics') },
  { value: 'Wissenschaft', label: t('info.dashboard.categories.science') },
  { value: 'Kultur', label: t('info.dashboard.categories.culture') },
  { value: 'Wirtschaft', label: t('info.dashboard.categories.economy') }
]);
