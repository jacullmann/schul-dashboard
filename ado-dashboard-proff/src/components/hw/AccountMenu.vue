...
import ThemeMenuDropdown from '@/components/hw/ThemeMenuDropdown.vue';
import LocaleMenuDropdown from '@/components/hw/LocaleMenuDropdown.vue';
...
.menu-btn.danger:hover {
  background: var(--special--red-hover);
}
