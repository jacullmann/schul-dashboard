...
<template>
  <div>
    ...
    <ul>
      <li>
        <strong>Nutzungs- und Profildaten:</strong> Werden in der Regel für die Dauer der aktiven Zugehörigkeit zum Projekt gespeichert und nach Beendigung der Mitgliedschaft (z.B. Abschluss des Schuljahres) unverzüglich gelöscht oder irreversibel anonymisiert.
      </li>
      <li>
