...
export const brainTests: BrainTestDefinition[] = [
    {
        id: 'reaction-time',
        title: 'Reaktionszeit',
        description: 'Teste deine visuelle Reaktionsfähigkeit. Warte auf Grün und klicke so schnell du kannst.',
        unit: 'ms',
        scoreType: 'lower',
        color: '#ff335a',
        icon: 'Zap'
    },
    {
        id: 'number-memory',
        title: 'Zahlen merken',
        description: 'Erinnere dich an die längste Zahl, die du dir merken kannst. Die Zahl wird mit jedem Level länger.',
        unit: 'Level',
        scoreType: 'higher',
        color: '#af00ff',
        icon: 'Brain'
    },
    {
        ...
        description: 'Präge dir ein Muster auf einem Gitter ein und wähle die richtigen Kacheln aus.',
        unit: 'Level',
        scoreType: 'higher',
        color: '#5600ff',
        icon: 'Eye'
