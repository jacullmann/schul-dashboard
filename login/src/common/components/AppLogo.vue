...
const intervalId = setInterval(updateDay, 60_000);
...
<template>
  ...
  >
    ...
    <defs>
      <linearGradient id="login-bismuth-stops">
      ...
      <linearGradient xlink:href="#login-bismuth-stops" id="login-bismuth"
        x1="58.46209" y1="-160.82309" x2="1114.1292" y2="333.66876" gradientUnits="userSpaceOnUse" />
    </defs>
    <path style="fill: var(--color-onyx);"
    ...
    <path style="fill: url(#login-bismuth);"
    ...
    <text style="font-weight: 900; font-size: 560px; font-family: Inter, sans-serif; fill: var(--color-onyx);">
