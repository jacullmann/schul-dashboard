...
import { CreateItemDto, UpdateItemDto, UpdateEditorNoteDto, AddImageToItemDto, ReportItemDto } from './dto/items.dto';
...
export class ItemsController {
  ...
  deleteItem(
    ...
    return this.itemsService.deleteItem(tenantId, id, user.sub, user.globalRole, tenantRole);
  }
  ...
  updateItemNote(
    ...
    return this.itemsService.updateItemNote(tenantId, id, userId, body.editorNote);
  }
  ...
  deleteImage(
    ...
    return this.itemsService.deleteImage(tenantId, itemId, publicId, user.sub, user.globalRole, tenantRole);
  }
