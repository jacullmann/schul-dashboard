...
export class TodosController {
  ...
  @Put(':id')
  updateTodo(@CurrentUserId() userId: string, @Param('id') id: string, @Body() body: UpdateTodoDto) {
    return this.todosService.updateTodo(userId, id, body.title, body.description);
  }
  ...
  @Patch(':id/reorder')
  reorderTodo(@CurrentUserId() userId: string, @Param('id') id: string, @Body() body: ReorderTodoDto) {
    return this.todosService.reorderTodo(userId, id, body.prevPosition, body.nextPosition);
  }
