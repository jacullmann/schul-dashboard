...
import { ChangeMemberRoleDto, RenameGroupDto, CreateTimetableSubDto, CreateAnnouncementDto } from './dto/group-admin.dto';
...
export class GroupAdminController {
  ...
  changeMemberRole(
    ...
    return this.groupAdminService.changeMemberRole(tenantId, currentUserId, targetUserId, body.role);
  }
  ...
  removeMember(
    ...
    return this.groupAdminService.removeMember(tenantId, currentUserId, targetUserId);
  }
  ...
  cleanupOldItems(@ActiveTenantId() tenantId: string, @CurrentUserId() userId: string) {
  ...
  createAnnouncement(
    ...
    return this.groupAdminService.createAnnouncement(tenantId, userId, body.content, body.color, body.showAsPopup);
  }

  @TenantRoles('admin', 'moderator')
  @Delete('announcements/:id')
  deleteAnnouncement(@ActiveTenantId() tenantId: string, @Param('id') id: string) {
